...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // NowWhy brand colors - Orange accent
        brand: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
          ...
          800: '#9a3412',
          900: '#7c2d12',
          accent: '#f97316', // Alias for primary
        },
      },
      borderRadius: {
        '4xl': '2rem',
      ...
      animation: {
        ...
        'slide-in': 'slideIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) both',
      ...
      backgroundImage: {
        'grid-pattern': 'linear-gradient(to right, #80808008 1px, transparent 1px), linear-gradient(to bottom, #80808008 1px, transparent 1px)',
